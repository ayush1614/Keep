        ...
        <div className="container my-3">
            ...
            <form className='my-3'>
                ...
                <div className="form-group">
                    ...
                    <input type="text" className="form-control" id="description" name="description" value={note.description} onChange={handleOnChange} placeholder="Enter description" minLength={3} required />
                </div>
                <div className="form-group">
                    <label htmlFor="tag">Tag</label>
                    <input type="text" className="form-control" id="tag" name="tag" value={note.tag} onChange={handleOnChange} placeholder="Enter tag" />
                </div>
